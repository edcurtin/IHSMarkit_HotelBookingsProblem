...
namespace Hotel.Booking.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // ioc register DAL Booking Manager Interface and Implementation
            var bookingManager = BookingManager.Instance;

            services.AddSingleton<IBookingManager>(provider => bookingManager);
        }
